...
unsigned int D2DModeSwitchNotificationDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        ...
        FD_ISEDITABLE,    // FIELD_oldMode
        FD_ISEDITABLE,    // FIELD_newMode
...
void D2DModeSwitchNotificationDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_oldMode: pp->setOldMode((LteD2DMode)string2enum(value, "LteD2DMode")); break;
        case FIELD_newMode: pp->setNewMode((LteD2DMode)string2enum(value, "LteD2DMode")); break;
...
void D2DModeSwitchNotificationDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    switch (field) {
        ...
        case FIELD_oldMode: pp->setOldMode(static_cast<LteD2DMode>(value.intValue())); break;
        case FIELD_newMode: pp->setNewMode(static_cast<LteD2DMode>(value.intValue())); break;
